...
app.get('/all-applications-organizer', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let application = yield Application_1.ApplicationMongoose.find({}).lean();
    let evaluation = yield Evaluation_1.EvaluationMongoose.find;
...
app.get('/all-applications-judge', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/delete-application/:id', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
// deleteApplication
app.post('/post-evaluation/:id', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
app.get('/get-applications-judge', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let user = Object.assign({}, req.session.user);
    let usertype = "";
...
app.get('/get-applications-organizer', auth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let user = Object.assign({}, req.session.user);
    let usertype = "";
    if (user.signInStatus === "judge") {
        usertype = "judge";
