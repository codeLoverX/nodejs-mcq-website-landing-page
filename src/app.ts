...
app.get('/all-applications', auth, async (req: Request, res: Response, next: NextFunction) => {
    let user = { ...req.session.user }
    let usertype = ""
...
app.get('/get-application-judge', auth, async (req: Request, res: Response, next: NextFunction) => {
    let user = { ...req.session.user }
    let usertype = ""
    if (user.signInStatus === "judge") { usertype = "judge"; }
    else if (user.signInStatus === "organizer") { usertype = "organizer"; }
...
app.get('/get-application-organizer', auth, async (req: Request, res: Response, next: NextFunction) => {
    let user = { ...req.session.user }
    let usertype = ""
    if (user.signInStatus === "judge") { usertype = "judge"; }
    else if (user.signInStatus === "organizer") { usertype = "organizer"; }
